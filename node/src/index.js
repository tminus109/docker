...
const productsStorePath = path.join(__dirname, "store", "products.json");
...
app.get("/products", (req, res) => {
  fs.readFile(productsStorePath, (err, file) => {
...
app.post("/products", bodyParser.json(), (req, res) => {
  ...
  fs.readFile(productsStorePath, (err, file) => {
    ...
    fs.writeFile(productsStorePath, JSON.stringify(products), (err) => {
      res.send(newProduct);
    });
  });
});
...
app.put("/products/:egyediAzonosito", bodyParser.json(), (req, res) => {
  ...
  fs.readFile(productsStorePath, (err, file) => {
    ...
    fs.writeFile(productsStorePath, JSON.stringify(products), () => {
